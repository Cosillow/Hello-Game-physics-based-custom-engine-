...
// const SDL_Rect Body::getBoundingBox() const
// {
...
// void Body::addForce(ForceType forceType)
// {
//     switch (forceType)
//     {
...
// void Body::removeForce(ForceType forceType)
// {
//     this->_forces.erase(forceType);
// }


// void Body::applyImpulse(const Vector2& impulse)
// {
//     this->_velocity.x += impulse.x / this->_mass;
//     this->_velocity.y += impulse.y / this->_mass;
// }

// Vector2 Body::getBoundingBoxCenter() const
// {
